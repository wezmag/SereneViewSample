...
using SereneViewSample.Administration;
using SereneViewSample.Administration.Entities;
using SereneViewSample.Administration.Repositories;
using SereneViewSample.Common;
using Serenity;
using Serenity.Data;
...
namespace SereneViewSample.Membership.Pages
{
