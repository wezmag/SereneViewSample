    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SereneViewSample Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SereneViewSample Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SereneViewSample";
        }
