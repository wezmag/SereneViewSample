    ...
    declare namespace Db {
        ...
        namespace ProjectMgnt {
            ...
            namespace Project {
                ...
                export const ProjectHistories: string;
            ...
            namespace VProject {
                ...
                export const ProjectAddOnId: string;
                export const ProjectId: string;
                export const ProjectName: string;
            }
        }
